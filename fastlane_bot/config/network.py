...
class _ConfigNetworkMainnet(ConfigNetwork):
    """
    OneStable bot config -- network [Ethereum Mainnet]
    """
...
class _ConfigNetworkBase(ConfigNetwork):
    """
    OneStable bot config -- network [Base Mainnet]
    """
...
class _ConfigNetworkTenderly(ConfigNetwork):
    """
    OneStable bot config -- network [Ethereum Tenderly]
    """
