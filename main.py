...
def main(
    ...
    logging_header = f"""
            ...
            Please direct all questions/reporting to the OneStable Telegram channel: https://t.me/OneStableOfficial
    ...
    while True:
        ...
        try:
            ...
            mgr.cfg.logger.error(
                ...
                f"Please report this error to the OneStable Telegram channel if it persists."
